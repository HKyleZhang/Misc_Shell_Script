...
do
 ...
 if [ "${var}" == "${filetype}" ]; then
      java -jar /home/hk/Software/jmodeltest-2.1.10/jModelTest.jar -d ${file} -s 11 -S BEST -f -i -g 4 -AIC -BIC -AICc -DT -dLRT -uLnL -p -o ../${jmtfolder}/${jmt}       
 fi
done
...
rm -rf ../${alyfolder}
mkdir ../${alyfolder}
mv ../model_setting ../${jmtfolder} ${fd}/*.txt* ../${alyfolder}/
